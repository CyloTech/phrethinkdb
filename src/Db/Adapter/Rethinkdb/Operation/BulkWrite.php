...
use Phalcon\Db\Adapter\RethinkDB\BulkWriteResult;
use RethinkDB\Driver\BulkWrite as Bulk;
use RethinkDB\Driver\Server;
use RethinkDB\Driver\WriteConcern;
...
class BulkWrite implements Executable
{
     ...
     */
    public function __construct($databaseName, $tableName, array $operations, array $options = [])
    {
        if (empty($operations)) {
